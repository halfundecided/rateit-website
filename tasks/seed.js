...
const main = async () => {
  ...
  try {
    ...
    /* ADDING Fake Users */
    await users.addUser("halfundecided");
    await users.addUser("nburg");
    await users.addUser("dkim");
    await users.addUser("geunWoo");
    await users.addUser("Mike");
    await users.addUser("seyoung");
    await users.addUser("Yash");
    await users.addUser("Ayush");
    await users.addUser("Shiyan");
    await users.addUser("halfundecided");
    await users.addUser("nburg");
    await users.addUser("dkim");
    await users.addUser("geunWoo");
